...
ARG NEXT_PUBLIC_USE_EMULATOR=false
ARG NEXT_PUBLIC_USE_STORAGE=true
...
ENV NEXT_PUBLIC_USE_EMULATOR=$NEXT_PUBLIC_USE_EMULATOR
ENV NEXT_PUBLIC_USE_STORAGE=$NEXT_PUBLIC_USE_STORAGE
